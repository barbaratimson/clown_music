...
class YMApi {
    ...
    likeTracks(userId, tracks) {
        const request = PreparedRequest_1.apiRequest()
            .setPath(`/users/${userId}/likes/tracks/add-multiple`)
            .addHeaders(this.getAuthHeader())
            .setBodyData({
                "track-ids":tracks,
        });
    ...
    dislikeTracks(userId, tracks) {
        const request = PreparedRequest_1.apiRequest()
            .setPath(`/users/${userId}/likes/tracks/remove`)
            .addHeaders(this.getAuthHeader())
            .setBodyData({
                "track-ids":tracks,
        });
